...
class BookerProviderWorkCard extends StatelessWidget {
  BookerProviderWorkCard({
    super.key,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: NetworkImage(
                      bookDetail.providerDetails!.profileImage.toString(),
                    ),
                    fit: BoxFit.cover),
              ),
            ),
            ...
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  MainTextWidget(
                      text:
                      '${bookDetail.providerDetails?.firstName} ${bookDetail.providerDetails?.lastName}',
